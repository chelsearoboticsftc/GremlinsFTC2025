...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2221.836470111109;  // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2045.4217033203222;   // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -0.10315322479511184;  // -1909.3227925056099; // x position of the perpendicular encoder (in tick units)
    }
