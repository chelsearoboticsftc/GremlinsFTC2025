...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2177;  // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2025.8;   // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2018;  // -1909.3227925056099; // x position of the perpendicular encoder (in tick units)
    }
